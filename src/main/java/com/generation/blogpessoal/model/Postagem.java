...
@Table(name = "tb_postagens") // Definindo o nome que eu quero para a tabela, do contrário seria o nome da Classe
public class Postagem {
	...
	@NotBlank(message = "O atributo título é obrigatório!") // NotBlank ao inves de NotNull, se fosse Notnull poderiam varias espaços
